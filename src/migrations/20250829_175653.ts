...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "_publications_v_version_links" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "publications_links" ALTER COLUMN "icon_id" SET NOT NULL;
  ALTER TABLE "publications_links" ALTER COLUMN "label" SET NOT NULL;
  ALTER TABLE "publications_links" ALTER COLUMN "link" SET NOT NULL;
  ALTER TABLE "publications" ALTER COLUMN "title" SET NOT NULL;
  ALTER TABLE "publications" ALTER COLUMN "dates_to" SET NOT NULL;
  ALTER TABLE "publications" ALTER COLUMN "dates_from" SET NOT NULL;
  ALTER TABLE "publications" ALTER COLUMN "image_id" SET NOT NULL;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "publications_links" ALTER COLUMN "icon_id" DROP NOT NULL;
  ALTER TABLE "publications_links" ALTER COLUMN "label" DROP NOT NULL;
  ALTER TABLE "publications_links" ALTER COLUMN "link" DROP NOT NULL;
  ALTER TABLE "publications" ALTER COLUMN "title" DROP NOT NULL;
  ALTER TABLE "publications" ALTER COLUMN "dates_to" DROP NOT NULL;
  ALTER TABLE "publications" ALTER COLUMN "dates_from" DROP NOT NULL;
  ALTER TABLE "publications" ALTER COLUMN "image_id" DROP NOT NULL;
