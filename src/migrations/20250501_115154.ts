...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_experiances_fk" FOREIGN KEY ("experiances_id") REFERENCES "public"."experiances"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "experiances_updated_at_idx" ON "experiances" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "experiances_created_at_idx" ON "experiances" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "educations_updated_at_idx" ON "educations" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "educations_created_at_idx" ON "educations" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_experiances_id_idx" ON "payload_locked_documents_rels" USING btree ("experiances_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_educations_id_idx" ON "payload_locked_documents_rels" USING btree ("educations_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "experiances" CASCADE;
