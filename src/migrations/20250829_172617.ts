...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "_licenses_v_version_links" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_licenses_v" DISABLE ROW LEVEL SECURITY;
  DROP TABLE "_licenses_v_version_links" CASCADE;
  DROP TABLE "_licenses_v" CASCADE;
  DROP INDEX "licenses__status_idx";
  ALTER TABLE "licenses_links" ALTER COLUMN "icon_id" SET NOT NULL;
  ALTER TABLE "licenses_links" ALTER COLUMN "label" SET NOT NULL;
  ALTER TABLE "licenses_links" ALTER COLUMN "link" SET NOT NULL;
  ALTER TABLE "licenses" ALTER COLUMN "title" SET NOT NULL;
  ALTER TABLE "licenses" ALTER COLUMN "dates_to" SET NOT NULL;
  ALTER TABLE "licenses" ALTER COLUMN "dates_from" SET NOT NULL;
  ALTER TABLE "licenses" ALTER COLUMN "image_id" SET NOT NULL;
  ALTER TABLE "licenses" DROP COLUMN "_status";
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "licenses_links" ALTER COLUMN "icon_id" DROP NOT NULL;
  ALTER TABLE "licenses_links" ALTER COLUMN "label" DROP NOT NULL;
  ALTER TABLE "licenses_links" ALTER COLUMN "link" DROP NOT NULL;
  ALTER TABLE "licenses" ALTER COLUMN "title" DROP NOT NULL;
  ALTER TABLE "licenses" ALTER COLUMN "dates_to" DROP NOT NULL;
  ALTER TABLE "licenses" ALTER COLUMN "dates_from" DROP NOT NULL;
  ALTER TABLE "licenses" ALTER COLUMN "image_id" DROP NOT NULL;
  ALTER TABLE "licenses" ADD COLUMN "_status" "enum_licenses_status" DEFAULT 'draft';
