...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "_hackathons_v_version_links" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_hackathons_v" DISABLE ROW LEVEL SECURITY;
  DROP TABLE "_hackathons_v_version_links" CASCADE;
  DROP TABLE "_hackathons_v" CASCADE;
  DROP INDEX "hackathons__status_idx";
  ALTER TABLE "hackathons_links" ALTER COLUMN "icon_id" SET NOT NULL;
  ALTER TABLE "hackathons_links" ALTER COLUMN "label" SET NOT NULL;
  ALTER TABLE "hackathons_links" ALTER COLUMN "link" SET NOT NULL;
  ALTER TABLE "hackathons" ALTER COLUMN "title" SET NOT NULL;
  ALTER TABLE "hackathons" ALTER COLUMN "dates_to" SET NOT NULL;
  ALTER TABLE "hackathons" ALTER COLUMN "dates_from" SET NOT NULL;
  ALTER TABLE "hackathons" ALTER COLUMN "image_id" SET NOT NULL;
  ALTER TABLE "hackathons" DROP COLUMN "_status";
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "hackathons_links" ALTER COLUMN "icon_id" DROP NOT NULL;
  ALTER TABLE "hackathons_links" ALTER COLUMN "label" DROP NOT NULL;
  ALTER TABLE "hackathons_links" ALTER COLUMN "link" DROP NOT NULL;
  ALTER TABLE "hackathons" ALTER COLUMN "title" DROP NOT NULL;
  ALTER TABLE "hackathons" ALTER COLUMN "dates_to" DROP NOT NULL;
  ALTER TABLE "hackathons" ALTER COLUMN "dates_from" DROP NOT NULL;
  ALTER TABLE "hackathons" ALTER COLUMN "image_id" DROP NOT NULL;
  ALTER TABLE "hackathons" ADD COLUMN "_status" "enum_hackathons_status" DEFAULT 'draft';
