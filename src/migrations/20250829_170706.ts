...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "_achievements_v_version_links" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_achievements_v" DISABLE ROW LEVEL SECURITY;
  DROP TABLE "_achievements_v_version_links" CASCADE;
  DROP TABLE "_achievements_v" CASCADE;
  DROP INDEX "achievements__status_idx";
  ALTER TABLE "achievements_links" ALTER COLUMN "icon_id" SET NOT NULL;
  ALTER TABLE "achievements_links" ALTER COLUMN "label" SET NOT NULL;
  ALTER TABLE "achievements_links" ALTER COLUMN "link" SET NOT NULL;
  ALTER TABLE "achievements" ALTER COLUMN "title" SET NOT NULL;
  ALTER TABLE "achievements" ALTER COLUMN "dates_to" SET NOT NULL;
  ALTER TABLE "achievements" ALTER COLUMN "dates_from" SET NOT NULL;
  ALTER TABLE "achievements" ALTER COLUMN "image_id" SET NOT NULL;
  ALTER TABLE "achievements" DROP COLUMN "_status";
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "achievements_links" ALTER COLUMN "icon_id" DROP NOT NULL;
  ALTER TABLE "achievements_links" ALTER COLUMN "label" DROP NOT NULL;
  ALTER TABLE "achievements_links" ALTER COLUMN "link" DROP NOT NULL;
  ALTER TABLE "achievements" ALTER COLUMN "title" DROP NOT NULL;
  ALTER TABLE "achievements" ALTER COLUMN "dates_to" DROP NOT NULL;
  ALTER TABLE "achievements" ALTER COLUMN "dates_from" DROP NOT NULL;
  ALTER TABLE "achievements" ALTER COLUMN "image_id" DROP NOT NULL;
  ALTER TABLE "achievements" ADD COLUMN "_status" "enum_achievements_status" DEFAULT 'draft';
