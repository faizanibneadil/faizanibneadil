...
type TConfigurations = Exclude<Page['configurations'], undefined>
...
export async function CollectionRenderer(props: { params: Promise<{ slug: TCollections, domain: string }> }) {
    const { params, } = props || {}
