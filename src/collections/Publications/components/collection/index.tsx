...
type Props = { collection: PaginatedDocs<DataFromCollectionSlug<'publications'>>, params: Awaited<PagePropsWithParams['params']> }
export function Publications(props: Props) {
