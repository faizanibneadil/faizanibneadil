...
export const Skills: CollectionConfig<'skills'> = {
    ...
    defaultPopulate: {
        ...
        createdAt:true,
        educations:true,
        enableAchievementsCount:true,
        enableCertificationsCount:true,
        enableEducationsCount:true,
        enableExperiencesCount:true,
        enableHackathonsCount:true,
        enableIcon:true,
        enableLabel:true,
        enableProjectsCount:true,
        enablePublicationsCount:true,
        enableResearchesCount:true,
        experiences:true,
        hackathons:true,
        icon:true,
        projects:true,
