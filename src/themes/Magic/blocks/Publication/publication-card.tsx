  ...
  return (
    <li className="relative ml-10 py-4">
      ...
      <div className="flex flex-1 flex-col justify-start gap-1">
        ...
        <MagicRichText className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed" data={publication?.description} params={params} searchParams={searchParams} />
      </div>
