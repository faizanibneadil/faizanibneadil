...
export const __MagicCollectionsMap: CollectionMapType = {
    blogs: {
        ...
        component: dynamic(() => import("@/themes/Magic/collections/blogs").then(({ Blogs }) => ({
            default: Blogs
        })), { ssr: true }),
        metadata: ({ doc }) => ({
    ...
    projects: {
        enableDocumentView: true,
        component: dynamic(() => import("@/themes/Magic/collections/projects").then(({ Projects }) => ({
            default: Projects
        })), { ssr: true }),
        metadata: ({ doc }) => ({
            title: doc?.meta?.title || doc?.title || 'Unknown Document.',
    ...
    achievements: {
        enableDocumentView: true,
        component: dynamic(() => import("@/themes/Magic/collections/achievements").then(({ Achievements }) => ({
    ...
    certifications: {
        enableDocumentView: true,
        component: dynamic(() => import("@/themes/Magic/collections/certifications").then(({ Certifications }) => ({
    ...
    hackathons: {
        enableDocumentView: true,
        component: dynamic(() => import("@/themes/Magic/collections/hackathons").then(({ Hackathons }) => ({
            default: Hackathons
        })), { ssr: true }),
        metadata: ({ doc }) => ({
            title: doc?.meta?.title || doc?.title || 'Unknown Document.',
    ...
    publications: {
        enableDocumentView: true,
        component: dynamic(() => import("@/themes/Magic/collections/publications").then(({ Publications }) => ({
    ...
    researches: {
        enableDocumentView: true,
        component: dynamic(() => import("@/themes/Magic/collections/researches").then(({ Researches }) => ({
            default: Researches
        })), { ssr: true }),
        metadata: ({ doc }) => ({
            title: doc?.meta?.title || doc?.title || 'Unknown Document.',
