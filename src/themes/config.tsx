...
import { BlockSlug, CollectionSlug, DataFromCollectionSlug, PaginatedDocs } from "payload";
...
export type ThemeConfig = {
    ...
    description: string,
    getRegistry: {
        getCollectionsRegistries: () => TCollectionRegistries
        getBlocksRegistries: () => TBlocksRegistries
    }
}
export const _themesRegistry: Record<string, ThemeConfig> = {
    magic: {
        visualizer: {
            type: 'video',
            url: '/magic-ui-portfolio-template.mp4'
        },
        description: 'Template from Magic UI Portfolio Template',
        label: 'Magic',
        getRegistry: () => ({
            // getBlocksRegistries: () => ({
            //     hero: {
    ...
    //         url: ''
    //     },
    //     description: 'Custom Solution Of Fancy Theme',
    //     label: 'Fancy',
    //     getRegistry: () => ({
    //         getBlocksRegistries: () => ({
