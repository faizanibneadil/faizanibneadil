...
import { BlocksRegistries } from "../blocks-registries";

export async function SkillShelfBlocksRenderer(props: BlocksRegistryProps) {
    const {
        blocks = [],
            ...
            <div className="bg-border rounded-lg">
                ...
                {blocks.map((block, index) => {
                    ...
                    if (Object.hasOwn(BlocksRegistries, blockType)) {
                        ...
                        if (Block) {
                            return (
                                <div className="" key={`${blockType}-${index}`}>
